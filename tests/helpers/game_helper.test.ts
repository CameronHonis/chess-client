    ...
    describe("#getLegalMovesForPawn", () => {
        describe("when the pawn can capture either direction", () => {
            describe("and the square in front is not occupied", () => {
                it("returns the correct moves", () => {
                    ...
                    const boardState = Board.fromFEN(fen);
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(4, 6), new Square(5, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                        new Move(ChessPiece.WHITE_PAWN, new Square(4, 6), new Square(5, 5), [], ChessPiece.BLACK_PAWN, ChessPiece.EMPTY),
                        new Move(ChessPiece.WHITE_PAWN, new Square(4, 6), new Square(5, 7), [], ChessPiece.BLACK_KNIGHT, ChessPiece.EMPTY),
                    ];
                ...
                describe("and the capture results in a check", () => {
                    it("returns the correct moves", () => {
                        ...
                        const boardState = Board.fromFEN(fen);
                        const expMoves = [
                            new Move(ChessPiece.WHITE_PAWN, new Square(6, 3), new Square(7, 4), [new Square(7, 4)], ChessPiece.BLACK_KNIGHT, ChessPiece.EMPTY),
                            new Move(ChessPiece.WHITE_PAWN, new Square(6, 3), new Square(7, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                            new Move(ChessPiece.WHITE_PAWN, new Square(6, 3), new Square(7, 2), [], ChessPiece.BLACK_PAWN, ChessPiece.EMPTY),
                        ];
        ...
        describe("when the pawn can capture in one direction", () => {
            ...
            describe("and the square in front is occupied", () => {
                it("returns the correct moves", () => {
                    ...
                    const boardState = Board.fromFEN(fen);
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(4, 6), new Square(5, 5), [], ChessPiece.BLACK_ROOK, ChessPiece.EMPTY),
                    ];
                    const actualMoves = GameHelper.getLegalMovesForPawn(boardState, new Square(4, 6));
                    compareMoves(expMoves, actualMoves);
                });
        ...
        describe("when the pawn cannot capture either direction", () => {
            describe("and the 'attacked' squares are of the same color", () => {
                it("returns the correct moves", () => {
                    ...
                    const boardState = Board.fromFEN(fen);
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(3, 5), new Square(4, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                    ];
        ...
        describe("when the pawn can capture en passant to the left", () => {
            describe("and the square in front is not occupied", () => {
                it("returns the correct moves", () => {
                    ...
                    const boardState = Board.fromFEN(fen);
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(5, 6), new Square(6, 5), [], ChessPiece.BLACK_PAWN, ChessPiece.EMPTY),
                        new Move(ChessPiece.WHITE_PAWN, new Square(5, 6), new Square(6, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                    ];
        ...
        describe("when the pawn can capture en passant to the right", () => {
            describe("and the square in front is not occupied", () => {
                it("returns the correct moves", () => {
                    ...
                    const boardState = Board.fromFEN(fen);
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(5, 6), new Square(6, 7), [], ChessPiece.BLACK_PAWN, ChessPiece.EMPTY),
                        new Move(ChessPiece.WHITE_PAWN, new Square(5, 6), new Square(6, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                    ];
                    const actualMoves = GameHelper.getLegalMovesForPawn(boardState, new Square(5, 6));
                    compareMoves(expMoves, actualMoves);
        ...
        describe("when the pawn is on the starting row", () => {
            describe("and the two squares in front are not occupied", () => {
                it("returns the correct moves", () => {
                    ...
                    const boardState = Board.fromFEN(fen);
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(2, 2), new Square(3, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ...
                describe("and the square in front is not occupied", () => {
                    it("returns the correct moves", () => {
                        ...
                        const expMoves = [
                            ...
                            new Move(ChessPiece.WHITE_PAWN, new Square(7, 2), new Square(8, 1), [], ChessPiece.BLACK_ROOK, ChessPiece.WHITE_ROOK),
                            new Move(ChessPiece.WHITE_PAWN, new Square(7, 2), new Square(8, 1), [], ChessPiece.BLACK_ROOK, ChessPiece.WHITE_QUEEN),
                            new Move(ChessPiece.WHITE_PAWN, new Square(7, 2), new Square(8, 2), [], ChessPiece.EMPTY, ChessPiece.WHITE_KNIGHT),
                            new Move(ChessPiece.WHITE_PAWN, new Square(7, 2), new Square(8, 2), [], ChessPiece.EMPTY, ChessPiece.WHITE_BISHOP),
                            new Move(ChessPiece.WHITE_PAWN, new Square(7, 2), new Square(8, 2), [], ChessPiece.EMPTY, ChessPiece.WHITE_ROOK),
                            new Move(ChessPiece.WHITE_PAWN, new Square(7, 2), new Square(8, 2), [], ChessPiece.EMPTY, ChessPiece.WHITE_QUEEN),
                        ];
                        const actualMoves = GameHelper.getLegalMovesForPawn(boardState, new Square(7, 2));
                        compareMoves(expMoves, actualMoves);
                    });
        ...
        describe("when the pawn blocks a check", () => {
            it("returns the move that blocks the check", () => {
                const boardState = Board.fromFEN("k7/1b1B4/8/8/8/4PK2/8/8 w - - 0 1");
                const expMoves = [
                    new Move(ChessPiece.WHITE_PAWN, new Square(3, 5), new Square(4, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                ];
                const actualMoves = GameHelper.getLegalMovesForPawn(boardState, new Square(3, 5));
            ...
            describe("and the pawn is able to capture", () => {
                it("only returns the move that blocks the check", () => {
                    const boardState = Board.fromFEN("k7/1b1B4/8/8/3q4/4PK2/8/8 w - - 0 1");
                    const expMoves = [
                        new Move(ChessPiece.WHITE_PAWN, new Square(3, 5), new Square(4, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                    ];
                    const actualMoves = GameHelper.getLegalMovesForPawn(boardState, new Square(3, 5));
    ...
    describe("#getLegalMovesForKnight", () => {
        ...
        describe("when the knight is in the bottom right corner", () => {
            it("returns two legal moves", () => {
                const boardState = Board.fromFEN("k7/1p6/8/8/8/8/8/6KN w - - 0 1");
                const expMoves = [
                    new Move(knight, new Square(1, 8), new Square(2, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(1, 8), new Square(3, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                ];
        ...
        describe("when the knight is unimpeded in the middle of the board", () => {
            it("returns all eight legal moves", () => {
                const boardState = Board.fromFEN("k7/8/8/8/p3N3/8/8/6K1 w - - 0 1");
                const expMoves = [
                    new Move(knight, new Square(4, 5), new Square(6, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(6, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(5, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(5, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(3, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(3, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(2, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(knight, new Square(4, 5), new Square(2, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when different pieces occupy land squares", () => {
            it("returns only moves that capture enemy pieces", () => {
                const boardState = Board.fromFEN("k4r2/7N/5P2/6q1/p7/8/8/4K3 w - - 0 1");
                const expMoves = [
                    new Move(knight, new Square(7, 8), new Square(8, 6), [], ChessPiece.BLACK_ROOK, ChessPiece.EMPTY),
                    new Move(knight, new Square(7, 8), new Square(5, 7), [], ChessPiece.BLACK_QUEEN, ChessPiece.EMPTY),
                ];
        ...
        describe("when a move results in a check", () => {
            it("returns the move with the knight's square as the checking square", () => {
                const boardState = Board.fromFEN("5B2/7N/5P2/6q1/p7/7k/8/4K3 w - - 0 1");
                const expMoves = [
                    new Move(knight, new Square(7, 8), new Square(5, 7), [new Square(5, 7)], ChessPiece.BLACK_QUEEN, ChessPiece.EMPTY)
                ];
                const actualMoves = GameHelper.getLegalMovesForKnight(boardState, new Square(7, 8));
                compareMoves(expMoves, actualMoves);
            });
            describe("and the move is a discovered double check", () => {
                it("returns the move with the knight and rook checking the piece", () => {
                    const boardState = Board.fromFEN("5B1R/7N/5P2/6q1/p7/7k/8/4K3 w - - 0 1");
                    const expMoves = [
                        new Move(knight, new Square(7, 8), new Square(5, 7), [new Square(5, 7), new Square(8, 8)], ChessPiece.BLACK_QUEEN, ChessPiece.EMPTY),
                    ];
                    const actualMoves = GameHelper.getLegalMovesForKnight(boardState, new Square(7, 8));
                    compareMoves(expMoves, actualMoves);
                });
    ...
    describe("#getLegalMovesForBishop", () => {
        ...
        describe("when the bishop is unimpeded in the middle of the board", () => {
            it("returns 13 legal moves", () => {
                const boardState = Board.fromFEN("2K5/8/8/4B3/8/8/8/5k2 w - - 0 1");
                const expMoves = [
                    new Move(bishop, new Square(5, 5), new Square(1, 1), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(2, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(3, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(4, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(6, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(7, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(8, 8), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(8, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(7, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(6, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(4, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(3, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 5), new Square(2, 8), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when a friendly piece is blocking its path", () => {
            it("does not return moves on or beyond the friendly piece", () => {
                const boardState = Board.fromFEN("2K5/8/8/8/3P4/8/8/B4k2 w - - 0 1");
                const expMoves = [
                    new Move(bishop, new Square(1, 1), new Square(2, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(1, 1), new Square(3, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when an enemy piece is blocking its path", () => {
            it("returns only moves up to and capturing the enemy piece", () => {
                ...
                const boardState = Board.fromFEN("2K5/8/8/8/3q4/8/8/B4k2 w - - 0 1");
                const expMoves = [
                    new Move(bishop, new Square(1, 1), new Square(2, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(1, 1), new Square(3, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(1, 1), new Square(4, 4), [], ChessPiece.BLACK_QUEEN, ChessPiece.EMPTY),
                ];
                const actualMoves = GameHelper.getLegalMovesForBishop(boardState, new Square(1, 1));
                compareMoves(expMoves, actualMoves);
            });
        ...
        describe("when the move results in a double king check", () => {
            it("contains a move with two checking squares", () => {
                const boardState = Board.fromFEN("2K5/5R2/4P1N1/5B2/4P3/8/8/5k2 w - - 0 1");
                const expMoves = [
                    new Move(bishop, new Square(5, 6), new Square(4, 7), [new Square(7, 6)], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(bishop, new Square(5, 6), new Square(3, 8), [new Square(7, 6), new Square(3, 8)], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
    ...
    describe("#getLegalMovesForRook", () => {
        ...
        describe("when the rook is unimpeded in the middle of the board", () => {
            it("returns all 14 moves", () => {
                const boardState = Board.fromFEN("5K1k/7p/8/8/3R4/8/8/8 w - - 0 1");
                const expMoves = [
                    new Move(rook, new Square(4, 4), new Square(4, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(4, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(4, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(4, 8), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(4, 1), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(4, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(4, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(1, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(2, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(3, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(5, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(6, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(7, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(4, 4), new Square(8, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when the rook is impeded by both friendly and enemy pieces", () => {
            it("does not return friendly captures and moves beyond other pieces", () => {
                const boardState = Board.fromFEN("R1N5/7p/q7/8/8/4K3/8/6k1 w - - 0 1");
                const expMoves = [
                    new Move(rook, new Square(8, 1), new Square(7, 1), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(rook, new Square(8, 1), new Square(6, 1), [], ChessPiece.BLACK_QUEEN, ChessPiece.EMPTY),
                    new Move(rook, new Square(8, 1), new Square(8, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                ];
        ...
        describe("when the rook move results in a check", () => {
            it("returns a move with a checking square", () => {
                const boardState = Board.fromFEN("R1N5/Q6p/8/8/8/4K3/8/1k6 w - - 0 1");
                const expMoves = [
                    new Move(rook, new Square(8, 1), new Square(8, 2), [new Square(8, 2)], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
                const actualMoves = GameHelper.getLegalMovesForRook(boardState, new Square(8, 1));
                compareMoves(expMoves, actualMoves);
            });
    ...
    describe("#getLegalMovesForQueen", () => {
        ...
        describe("when the queen is unimpeded in the middle of the board", () => {
            it("returns all possible queen moves", () => {
                const boardState = Board.fromFEN("kr6/pp6/5K2/8/2Q5/8/8/8 w - - 0 1");
                const expMoves = [
                    new Move(queen, new Square(4, 3), new Square(4, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(4, 1), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(4, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(4, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(4, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(4, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(4, 8), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(1, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(2, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(3, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(5, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(6, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(7, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(8, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(3, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(2, 1), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(5, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(6, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(7, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(8, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(5, 2), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(6, 1), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(3, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(2, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(queen, new Square(4, 3), new Square(1, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
    ...
    describe("#getLegalMovesForKing", () => {
        ...
        describe("when the king is unimpeded in the middle of the board", () => {
            it("returns all 8 moves", () => {
                const boardState = Board.fromFEN("k7/p7/5K2/8/8/8/8/8 w - - 0 1");
                const expMoves = [
                    new Move(king, new Square(6, 6), new Square(7, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(7, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(7, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(6, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(6, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(5, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(5, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(6, 6), new Square(5, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when the king is unimpeded on the corner of the board", () => {
            it("does not include moves out of the board space", () => {
                const boardState = Board.fromFEN("k7/p7/8/8/8/8/8/7K w - - 0 1");
                const expMoves = [
                    new Move(king, new Square(1, 8), new Square(1, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(1, 8), new Square(2, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(1, 8), new Square(2, 8), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when the king is one square away from enemy king", () => {
            it("can not move adjacent to the enemy king", () => {
                const boardState = Board.fromFEN("8/p7/8/8/1k1K4/8/8/8 w - - 0 1");
                const expMoves = [
                    new Move(king, new Square(4, 4), new Square(5, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(4, 4), new Square(3, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(4, 4), new Square(5, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(4, 4), new Square(4, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                    new Move(king, new Square(4, 4), new Square(3, 5), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                ];
        ...
        describe("when the king is checkmated on the back rank by a defended queen", () => {
            it("returns no legal moves", () => {
                const boardState = Board.fromFEN("3K4/3q4/3k4/8/8/8/8/8 w - - 0 1");
            ...
            describe("and a piece occupies a square between the king and kingside rook", () => {
                describe("and the king is white", () => {
                    it("does not return a move to castle kingside", () => {
                        const boardState = Board.fromFEN("4k3/p7/8/8/8/8/3PPP2/3QK1NR w K - 0 1");
                        const expMoves = [
                            new Move(king, new Square(1, 5), new Square(1, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                        ];
                ...
                describe("and the king is black", () => {
                    it("does not return a move to castle kingside", () => {
                        const boardState = Board.fromFEN("3pkb1r/3ppp2/8/8/8/8/8/3K4 b k - 0 1");
                        const expMoves: Move[] = [];
            ...
            describe("and all pieces are cleared between the king and kingside rook", () => {
                describe("and the king is white", () => {
                    it("returns a move to castle kingside", () => {
                        const boardState = Board.fromFEN("4k3/p7/8/8/8/5N2/3PPP2/3QK2R w K - 0 1");
                        const expMoves = [
                            new Move(king, new Square(1, 5), new Square(1, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                            new Move(king, new Square(1, 5), new Square(1, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                        ];
                        const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(1, 5));
                        compareMoves(expMoves, actualMoves);
                    });
                ...
                describe("and the king is black", () => {
                    it("returns a move to castle kingside", () => {
                        const boardState = Board.fromFEN("3pk2r/3ppp2/3b4/8/8/8/8/3K4 b k - 0 1");
                        const expMoves = [
                            new Move(black_king, new Square(8, 5), new Square(8, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                            new Move(black_king, new Square(8, 5), new Square(8, 7), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                        ];
                        const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(8, 5));
                        compareMoves(expMoves, actualMoves);
                    });
                ...
                describe("and a square between castle squares is covered by an enemy rook", () => {
                    describe("and the king is white", () => {
                        it("does not return a move to castle kingside", () => {
                            const boardState = Board.fromFEN("4k1r1/p7/8/8/8/5N2/3PPP2/3QK2R w K - 0 1");
                            const expMoves = [
                                new Move(king, new Square(1, 5), new Square(1, 6), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                            ];
                            const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(1, 5));
                    ...
                    describe("and the king is black", () => {
                        it("does not return a move to castle kingside", () => {
                            const boardState = Board.fromFEN("3pk2r/3pp1p1/3b4/8/8/8/8/3K1R2 b k - 0 1");
                            const expMoves: Move[] = [];
                            const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(8, 5));
                            compareMoves(expMoves, actualMoves);
                        });
            ...
            describe("and a piece occupies a square between the king and kingside rook", () => {
                describe("and the king is white", () => {
                    it("does not return a move to castle queenside", () => {
                        const boardState = Board.fromFEN("4k3/8/2p5/8/8/8/3PPP2/R2QKB2 w Q - 0 1");
                        const expMoves: Move[] = [];
                        const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(1, 5));
                        compareMoves(expMoves, actualMoves);
                    });
                ...
                describe("and the king is black", () => {
                    it("does not return a move to castle queenside", () => {
                        const boardState = Board.fromFEN("r2qkb2/3ppp2/8/8/8/8/3PPP2/R2QKB2 b q - 1 1");
                        const expMoves: Move[] = [];
                        const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(8, 5));
                        compareMoves(expMoves, actualMoves);
                    });
            ...
            describe("and all pieces are cleared between the king and queenside rook", () => {
                describe("and the king is white", () => {
                    it("returns a move to castle queenside", () => {
                        const boardState = Board.fromFEN("r2qkb2/3ppp2/8/8/8/8/3PPP2/R3KB2 w Qq - 1 1");
                        const expMoves: Move[] = [
                            new Move(king, new Square(1, 5), new Square(1, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                            new Move(king, new Square(1, 5), new Square(1, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                        ];
                        const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(1, 5));
                        compareMoves(expMoves, actualMoves);
                    });
                ...
                describe("and the king is black", () => {
                    it("returns a move to castle queenside", () => {
                        const boardState = Board.fromFEN("r3kb2/3ppp2/8/8/8/8/3PPP2/R3KB2 b Qq - 1 1");
                        const expMoves: Move[] = [
                            new Move(black_king, new Square(8, 5), new Square(8, 3), [], ChessPiece.EMPTY, ChessPiece.EMPTY),
                            new Move(black_king, new Square(8, 5), new Square(8, 4), [], ChessPiece.EMPTY, ChessPiece.EMPTY)
                        ];
                        const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(8, 5));
                        compareMoves(expMoves, actualMoves);
                    });
                ...
                describe("and a square between castle squares is covered by an enemy rook", () => {
                    describe("and the king is white", () => {
                        it("does not return a move to castle queenside", () => {
                            const boardState = Board.fromFEN("3rkb2/4pp2/8/8/8/8/4PP2/R3KB2 w Q - 1 1");
                            const expMoves: Move[] = [];
                            const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(1, 5));
                            compareMoves(expMoves, actualMoves);
                        });
                    ...
                    describe("and the king is black", () => {
                        it("does not return a move to castle queenside", () => {
                            const boardState = Board.fromFEN("r3kb2/4pp2/8/8/8/8/4PP2/3RKB2 b q - 1 1");
                            const expMoves: Move[] = [];
                            const actualMoves = GameHelper.getLegalMovesForKing(boardState, new Square(8, 5));
                            compareMoves(expMoves, actualMoves);
                        });
    ...
    describe('#getPieceSquaresCheckingKing', () => {
        describe("when the board is the initial board", () => {
            it("returns an empty list", () => {
                const checkingSquares = GameHelper.getPieceSquaresCheckingKing(Board.getInitBoardState())
        ...
        describe("when two kings are adjacent", () => {
            it("returns the adjacent king square", () => {
                const board = Board.fromFEN("8/8/8/3kK3/8/8/8/8 w - - 0 1");
    ...
    describe("#isForcedDraw", () => {
        describe("when remaining material forces a draw", () => {
            describe("and only the kings are on the board", () => {
                it("returns true", () => {
                    const boardState = Board.fromFEN("8/8/8/8/7K/8/8/k7 w - - 0 1");
            ...
            describe("when only one bishop exists", () => {
                describe("and its a white bishop", () => {
                    it("returns true", () => {
                        const boardState = Board.fromFEN("8/4B3/8/8/7K/8/8/k7 w - - 0 1")
                        expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                    });
                });
            ...
            describe("when both players have one bishop", () => {
                it("returns true", () => {
                    const boardState = Board.fromFEN("8/4B3/8/8/7K/8/3b4/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                });
            });
            describe("when a player has two same colored bishops", () => {
                describe("and the bishops are white", () => {
                    it("returns true", () => {
                        const boardState = Board.fromFEN("8/4B3/3B4/8/7K/8/8/k7 w - - 0 1");
                        expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                    });
                });
                describe("when the bishops are black", () => {
                    it("returns true", () => {
                        const boardState = Board.fromFEN("8/5b2/4b3/8/7K/8/8/k7 w - - 0 1");
                        expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                    });
                });
            });
            describe("when only one knight exists", () => {
                describe("and the knight is white", () => {
                    it("returns true", () => {
                        const boardState = Board.fromFEN("8/8/8/8/4N2K/8/8/k7 w - - 0 1");
                        expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                    });
                });
                describe("and the knight is black", () => {
                    it("returns true", () => {
                        const boardState = Board.fromFEN("8/8/4n3/8/7K/8/8/k7 w - - 0 1");
                        expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                    });
                });
            });
            describe("when both players have only one knight", () => {
                it("returns true", () => {
                    const boardState = Board.fromFEN("5n2/8/8/8/4N2K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeTruthy();
                });
            });
        });
        describe("when remaining material does not force a draw", () => {
            describe("when only one rook exists", () => {
                it("returns false", () => {
                    const boardState = Board.fromFEN("8/2R5/8/8/7K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeFalsy();
                });
            });
            describe("when only one queen exists", () => {
                it("returns false", () => {
                    const boardState = Board.fromFEN("8/8/4q3/8/7K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeFalsy();
                });
            });
            describe("when only one pawn exists", () => {
                it("returns false", () => {
                    const boardState = Board.fromFEN("8/8/8/6P1/7K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeFalsy();
                });
            });
            describe("when a player has two different colored bishops", () => {
                it("returns false", () => {
                    const boardState = Board.fromFEN("8/4B3/4B3/8/7K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeFalsy();
                });
            });
            describe("when only one player has a bishop and knight", () => {
                it("returns false", () => {
                    const boardState = Board.fromFEN("8/4B3/4N3/8/7K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeFalsy();
                });
            });
            describe("when only one player has two knights", () => {
                it("returns false", () => {
                    const boardState = Board.fromFEN("8/8/4n3/4n3/7K/8/8/k7 w - - 0 1");
                    expect(GameHelper.isForcedDraw(boardState.material)).toBeFalsy();
                });
            });
        });
